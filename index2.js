document.getElementById("goldopenPackImage").addEventListener("click", function () {
	// Simulate pack opening (replace with your logic)
	const goldpackContents = [
	...
	const openPackImage = document.getElementById("goldopenPackImage");
