...
document.getElementById("openCustomPackImage").addEventListener("click", function () {
    ...
    const packContentsDiv = document.getElementById("customPackContents");
    const openPackImage = document.getElementById("openCustomPackImage");
    ...
    // Disable the "Open Pack" button to prevent multiple clicks
    openCustomPackImage.disabled = true;
